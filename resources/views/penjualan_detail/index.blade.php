                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-info" onclick="showProduct()">...</button>
                            </span>
                            </div>
                        </div>
                    </div>
...
<div class="col-md-4">
    <form action="transaksi/simpan" method="post" class="form form-horizontal form-penjualan">
    @csrf 
    <input type="text" name="idpenjualan" value="{{ $idpenjualan }}">
    <input type="hidden" name="total" id="total">
    <input type="hidden" name="totalitem" id="totalitem">
    <input type="hidden" name="bayar" id="bayar">
    <input type="text" name="id_user" id="id_user" value="{{ $id_user }}">
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" class="form-control" id="kembali" value="0" name="kembali" readonly>
    </div>
</div>
    </form>
</div>
...
// 4. jalankan fungsi laodForm() ketika diterima diubah
