...
<div class="modal-body">
   ...
   <div class="form-group">
      ...
      <div class="col-md-6">
         <input id="kode_member2" type="number" class="form-control" name="kode_member2" autofocus required>
   ...
   <div class="form-group">
      ...
      <div class="col-md-6">
         <input id="nama2" type="text" class="form-control" name="nama2" autofocus required>
         <span class="help-block with-errors"></span>
      </div>
   </div>
   ...
   <div class="form-group">
      ...
      <div class="col-md-8">
         <input id="alamat2" type="text" class="form-control" name="alamat2" required>
         <span class="help-block with-errors"></span>
      </div>
   </div>
   ...
   <div class="form-group">
      ...
      <div class="col-md-6">
         <input id="telepon2" type="text" class="form-control" name="telepon2" autofocus required>
         <span class="help-block with-errors"></span>
      </div>
   </div>
